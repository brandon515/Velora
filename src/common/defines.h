...
#define VELORA_MAX_MATERIALS 256
#define VELORA_MAX_JOINTS 256
#define VELORA_TEXTURES_PER_MATERIAL 1
#define VELORA_MAX_TEXTURES (VELORA_MAX_MATERIALS * VELORA_TEXTURES_PER_MATERIAL)