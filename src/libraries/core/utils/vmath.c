...
u64 log_base_2_unchecked(u64 input){
  ...
  return magicTable[(u64)(input * 0x022fdd63cc95386dull) >> 58];
}

u64 log_base_2(u64 input){
  u64 powerOfTwo = round_up_to_largest_power_of_two(input);
  return log_base_2_unchecked(powerOfTwo);
}